...
@Component({
  selector: 'CarInventory-home',
  templateUrl: './CarInventory-home.component.html',
  styleUrls: ['./CarInventory-home.component.scss']
})
export class CarInventoryHomeComponent implements AfterViewInit {
