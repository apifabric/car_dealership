...
@Component({
  selector: 'DealershipEmployee-home',
  templateUrl: './DealershipEmployee-home.component.html',
  styleUrls: ['./DealershipEmployee-home.component.scss']
})
export class DealershipEmployeeHomeComponent implements AfterViewInit {
