...
@Component({
  selector: 'InventoryPart-home',
  templateUrl: './InventoryPart-home.component.html',
  styleUrls: ['./InventoryPart-home.component.scss']
})
export class InventoryPartHomeComponent implements AfterViewInit {
