...
def expose_models(api, method_decorators = []): 
    ...
    """
    api.expose_object(database.models.CarInventory, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.Dealership, method_decorators= method_decorators)
    api.expose_object(database.models.DealershipEmployee, method_decorators= method_decorators)
    api.expose_object(database.models.Employee, method_decorators= method_decorators)
    api.expose_object(database.models.InventoryPart, method_decorators= method_decorators)
